 ...
 * the asset manager.
 */
abstract contract AssetManager is Context, Ownable {
     ...
     */
    event AssetManagerTransferred(
        address indexed previousAssetManager,
    ...
    modifier onlyOwnerOrAssetManager() {
        require(
            assetManager() == _msgSender() || owner() == _msgSender(),
            "onlyOwnerOrAssetManager/owner-or-manager"
        );
        _;
    }
